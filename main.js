...
let lowFilter = document.getElementById('checkbox-low');
lowFilter.onchange = function(){
    if(lowFilter.checked === true){
        for(let i = 0 ; i < alljewellerys .length; i++){
            if(alljewellerys[i].dataset.category === 'low'){
                alljewellerys[i].style.display = 'block';
            }
        }
    }
...
let mediumFilter = document.getElementById('checkbox-medium');
mediumFilter.onchange = function(){
    if(mediumFilter.checked === true){
        for(let i = 0 ; i < alljewellerys.length; i++){
            if(alljewellerys[i].dataset.category === 'medium'){
                alljewellerys[i].style.display = 'block';
            }
        }
    }
